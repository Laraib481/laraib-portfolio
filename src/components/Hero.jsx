...
import myFrontImage from '../assets/front-image.jpeg';
import resumePdf from '../assets/Resume.pdf'; // Apna Resume PDF path check kar lein
...
export default function Hero() {
  ...
  return (
    <div ref={containerRef} className="relative h-[300vh] w-full">
          ...
          >
            ...
            <div className="md:col-span-4 space-y-2 sm:space-y-4 text-xs sm:text-sm font-medium text-neutral-700 leading-relaxed bg-white/40 md:bg-transparent p-3 sm:p-0 rounded-xl backdrop-blur-xs md:backdrop-blur-none border border-black/5 md:border-none">
              ...
              <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-1">
                ...
                {/* 3. RESUME BUTTON (OPENS PREVIEW MODAL) */}
                <button
                  onClick={() => setIsResumeOpen(true)}
                  className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 bg-[#B30000] hover:bg-[#800000] text-white rounded-full text-xs font-bold transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5 cursor-pointer"
                >
      ...
      {/* RESUME PDF MODAL (Certificate Modal style) */}
      {isResumeOpen && (
          ...
          <div className="bg-[#121212] text-white w-full max-w-5xl h-[88vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-neutral-800">
            ...
            <div className="px-5 py-4 bg-black flex items-center justify-between border-b border-neutral-800">
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div>
                  <h3 className="font-bold text-xs sm:text-sm text-white truncate max-w-xs sm:max-w-md">
                    Laraib Sarwar - Resume
                  </h3>
                  <p className="text-[10px] text-neutral-400 font-mono">
                    Official Document • Full-Stack Developer
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                <a
                  href={resumePdf}
                  download="Laraib_Sarwar_Resume.pdf"
